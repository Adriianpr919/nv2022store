...
export default function Options2Screen() {
  return (
    <Layout title="Políticas De Envios, Cambios, Devoluciones Y
    Garantías.">
      <main className="mt-5">
              ...
              <div className="col-md-12 gx-5 mb-4">
                ...
                <>
                  ...
                  <div style={{ textAlign: "justify" }} lang="es">
                    ...
                    POLÍTICAS DE CAMBIO:
                    <br />
                    Si deseas hacer el cambio de alguno de nuestros productos, lo puedes hacer de dos maneras: directamente en el Showroom de Nury Valenzuela, presentando tu factura de compra, en un plazo de 24/48 horas luego de la fecha en que fue efectuada la compra, o a través de nuestra página web https://www.nuryvalenzuelajoyeria.com.co/, (Dentro de Villavicencio (Meta) 2 días máximo) a nivel nacional 6 días hábiles y a nivel internacional de 10 a 20 días hábiles, luego de la entrega del producto.
                    <br />
                    ...
                    <br />
                    Cambios a través de https://www.nuryvalenzuelajoyeria.com.co/:
                    <br />
                    Si deseas hacer el cambio a través de https://www.nuryvalenzuelajoyeria.com.co/, (Dentro de Villavicencio (Meta) 2 días máximo) a nivel nacional 6 días hábiles y a nivel internacional de 10 a 20 días hábiles, luego de haber recibido el producto, debes ponerte en contacto con el área de Servicio al cliente de +57-3133966349  (en horario de lunes a viernes de 9am-6pm), a través de nuestro correo nuryvalenzuelajoyeria@gmail.com, o en nuestra página web https://www.nuryvalenzuelajoyeria.com.co/ en el formulario de ‘Contáctanos’.
                    <br />
                    ...
                    <br />
                    Bono o nota crédito para realizar una nueva compra https://www.nuryvalenzuelajoyeria.com.co/ (este bono tendrá vigencia de seis (6) meses). Devolución del dinero únicamente acorde al derecho de retracto consagrado por la ley 1480 de 2011 art. 47. Para hacer la devolución del envío DEBES utilizar el mismo empaque en que te entregamos tu pedido.
                    <br />
                    ...
                    <br />
                    &#45;&#41; Bono o nota crédito para realizar una nueva compra en https://www.nuryvalenzuelajoyeria.com.co/ será enviado a tu correo dos (2) días hábiles después recibido el producto en nuestra bodega.
                    <br />
